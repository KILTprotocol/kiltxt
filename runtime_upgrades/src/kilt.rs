...
pub use kilt::runtime_types::did::pallet as did;
pub use kilt::runtime_types::pallet_did_lookup::pallet as did_lookup;
pub use kilt::runtime_types::peregrine_runtime as kilt_runtime;
pub use kilt::*;
