...
use crate::kilt::runtime_types::did::did_details::DidCreationDetails;
use crate::kilt::runtime_types::did::did_details::DidSignature;
...
pub(crate) fn dummy_create_did(
    ...
    let creation_details = DidCreationDetails {
        ...
        new_key_agreement_keys:
            crate::kilt::runtime_types::sp_runtime::bounded::bounded_btree_set::BoundedBTreeSet(
                vec![],
            ),
...
pub(crate) fn dummy_link_account_with_did(
    ...
    crate::kilt::RuntimeCall::Did(
        crate::kilt::runtime_types::did::pallet::Call::submit_did_call {
